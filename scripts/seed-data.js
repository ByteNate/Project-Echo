...
async function seedData() {
  try {
    // Seed users
    const users = [
      { firstName: 'John', lastName: 'Doe', email: 'john@example.com', password: 'password', role: 'ADMIN' },
      { firstName: 'Jane', lastName: 'Smith', email: 'jane@example.com', password: 'password', role: 'TA' },
      { firstName: 'Mike', lastName: 'Johnson', email: 'mike@example.com', password: 'password', role: 'STUDENT' },
    ];
    ...
    // Seed pairings
    const pairings = [
      { classSchedule: seededClassSchedules[0]._id, ta: users[1]._id, student: users[2]._id },
    ];
